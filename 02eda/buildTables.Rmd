...
setkey(tableWord, id)
rm(freqs)
write.csv(tableWord, "../results/tables/tableWords.csv")
#rm(tableWord)
```
...
setnames(freqs, old = c("probability.x", "id"), new = c("probability", "id1"))
freqs <- freqs[,-c("term1", "probability.y")]
...
#tableBigram <- data.table(id1 = tableWord[word == , id]
#                              )
```
